          ...
          <footer className="container flex flex-col items-center justify-between py-3 m-auto space-x-4 space-y-3 md:py-12 md:items-start md:flex-row md:space-y-3">
            <div className="flex flex-col items-center justify-between flex-1 p-5 m-auto space-y-3 md:p-0 md:flex-col md-y-0 md:items-start">
              ...
              <p className="text-sm text-textPrimary">
                An ICT firm that provides financial solutions that automate
                challenges faced by small and medium-sized enterprises (SMEs) in
                Africa.
              </p>
            ...
            <div className="flex flex-col items-center justify-between flex-1 p-5 space-y-3 md:p-0 md-y-0 md:items-start">
              ...
              <a href="/news" className="text-sm text-textPrimary">
                News
              </a>
              <a href="/clients" className="text-sm text-textPrimary">
                Partners
              </a>
              <a href="/about" className="text-sm text-textPrimary">
                About
              </a>
              <a href="/careers" className="text-sm text-textPrimary">
                Careers
              </a>
            </div>
            ...
            <div className="flex flex-col items-center justify-between p-5 space-y-3 md:p-0 sm-y-0 md:items-start">
              ...
              <p className="text-sm text-textPrimary">
                Phone: +254 711 520 705
              </p>
              <p className="text-sm text-textPrimary">
                support@dataintegrated.co.ke
              </p>
              <p className="text-sm text-textPrimary">
                sales@dataintegrated.co.ke
              </p>
              <p className="text-sm text-textPrimary">
                Mobitill Center, Enterprise Rd
              </p>
          ...
          <div className="p-2 bg-white">
            <div className="container flex flex-col items-center justify-between px-5 mx-auto space-y-3 md:flex-row md:px-0">
              <p className="text-xs text-textPrimary">
                {new Date().getFullYear()} &copy; Data Integrated Ltd. All
                Rights Reserved
              </p>
              <div className="flex items-center gap-2">
                <a
                  href="/policy"
                  className="text-xs text-textPrimary hover:text-secondary"
                >
                  Privacy Policy
                </a>
