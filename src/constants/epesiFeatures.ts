export const featureContent = [
    ...
    {
      id: 2,
      title: "Timely Traffic Updates",
      icon: "/assets/products/icons/clock.svg",
      text: "Enables users to view traffic status thus selecting the fastest routes available.",
    },
    {
      id: 3,
      title: "Ride Hailing",
      icon: "/assets/products/icons/bus.svg",
      text: "Enables users to know the availability of buses by imputing the current location and their intended destination.",
    },
    {
      id: 4,
